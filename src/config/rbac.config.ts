...
export const SYSTEM_MODULES: ModulePermissionDef[] = [
  ...
  {
    id: 'projects',
    label: 'Dự Án & Công Việc Thi Công',
    category: 'operation',
    description: 'Quản lý dự án công trình, giao việc, tiến độ, nghiệm thu ký duyệt, mượn trả & quyết toán vật tư',
  },
  {
    id: 'approvals',
    label: 'Ký Duyệt & Trình Ký Đa Cấp',
    category: 'management',
    description: 'Quy trình phê duyệt tuần tự liên phòng ban (PR, PO, GRN, PXK, Lệnh SX, Giao hàng, Kế toán, Thu chi quỹ)',
  },
  {
    id: 'settings',
